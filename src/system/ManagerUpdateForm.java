 ...
 * @author SIOW HAN BIN
 */
public class ManagerUpdateForm extends javax.swing.JFrame {
      private ManageManagerForm manageForm;
   ...
   public ManagerUpdateForm(ManageManagerForm sf, String userID, String username) {
 ...
 this.userID = userID; 
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            if (!isUpdated) {
                JOptionPane.showMessageDialog(null, "No changes were made to the Manager details.");
            ...
            // Inform user of success and return to ManageManagerForm
            ...
            // Error handling
            JOptionPane.showMessageDialog(null, "Error updating Manager: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerUpdateForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ManagerUpdateForm().setVisible(true);
        });
    }
